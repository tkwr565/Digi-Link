...
> Find other Digimon fans in the real world.
...
Remember bumping into a stranger on the street who also had a Digivice? DigiMap brings that back — for adults, anywhere on the planet.
...
```bash
# 1. Clone the repo
git clone https://github.com/tkwr565/DigiMapHK.git
cd DigiMapHK
...
This is a personal fan project. Bug reports and suggestions are welcome via [GitHub Issues](https://github.com/tkwr565/DigiMapHK/issues). Pull requests may be considered at the maintainer's discretion.
